...
flags.DEFINE_string('train_logdir', '/Users/huanying/bai/dataset/CamVid/log',
...
# Dataset settings.
flags.DEFINE_string('dataset', 'camvid',
                    'Name of the segmentation dataset.')

flags.DEFINE_string('train_split', 'train',
                    'Which split of the dataset to be used for training')

flags.DEFINE_string('dataset_dir', '/Users/huanying/bai/dataset/CamVid/tfrecord', 'Where the dataset reside.')
